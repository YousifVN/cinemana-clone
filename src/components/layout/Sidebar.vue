<template>
    <div>
        <button @click="toggleSidebar" data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar"
            ...
            class="inline-flex items-center p-2 mt-2 text-sm text-gray-400 rounded-lg ms-3 sm:hidden focus:outline-none focus:ring-2 hover:bg-gray-700 focus:ring-gray-600">
